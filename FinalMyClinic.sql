...
INSERT INTO `doctor_tbl` VALUES (1,'Aeyc','Aba','Doe',54,'0928','2011-11-12','Male'),(2,'John','Diesel','Doe',24,'1234','2020-07-15','Female');
...
CREATE TABLE `doctoroperation_tbl` (
  ...
  CONSTRAINT `DoctorOperation1` FOREIGN KEY (`DoctorID`) REFERENCES `doctor_tbl` (`DoctorID`),
  CONSTRAINT `DoctorOperation2` FOREIGN KEY (`OperationCode`) REFERENCES `operation_tbl` (`OperationCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `doctoroperation_tbl` VALUES ('CE43',1),('CE43',2),('XE101',1),('XE101',2);
...
CREATE TABLE `frontdeskpatient_tbl` (
  ...
  CONSTRAINT `FrontDeskPatient1` FOREIGN KEY (`PatientID`) REFERENCES `patient_tbl` (`PatientID`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO `operation_tbl` VALUES ('CE43','X-RAY','2021-11-25','AAA',1,5000.00,'01:30:00'),('XE101','Surgery','2020-12-21','VVV',2,1000.00,'01:50:00');
...
-- Dump completed on 2025-03-08  0:50:58
